...
> [README.md](https://ecologistpablo.github.io/SharkpediaR/README.md)
> and the [pkgdown site](https://ecologistpablo.github.io/SharkpediaR/).

## Purpose

This document is intended for AI coding agents (Cursor, Claude Code
workflows, ECC-style systems) and human collaborators building the
`sharkipediaR` package.

The package goal is to provide a robust, reproducible,
tidyverse-oriented R interface to publicly accessible Sharkipedia data.
...
The Sharkipedia website appears primarily server-rendered using Ruby on
Rails + HTML.
